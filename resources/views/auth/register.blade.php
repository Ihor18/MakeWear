                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row justify-content-center ">
                            ...
                            <div class="col-8 mb-2">
                                <input id="firstName" type="text" placeholder="Имя" class="form-control @error('firstName') is-invalid @enderror" name="firstName" value="{{ old('firstName') }}" required autocomplete="firstName" autofocus>
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-8 mb-2">
                                <input id="name" type="text" placeholder="Фамилия" class="form-control @error('lastName') is-invalid @enderror" name="lastName" value="{{ old('lastName') }}" required autocomplete="lastName" autofocus>
                        ...
                        <div class="row justify-content-center ml-2 mr-2 mt-4 mb-4">
                        <div class="form-check col-6">
                            <input class="form-check-input" type="radio" name="Buyer" value="Wholesale" id="flexRadioDefault1">
                            <label class="form-check-label" for="flexRadioDefault1">
                                Оптовый покупатель
                            </label>
                        </div>
                        <div class="form-check col-6 justify-content-center">
                            <input class="form-check-input" type="radio" name="Buyer" value="Retail" id="flexRadioDefault2" checked>
